...
def send_confirmation_email(lead_name, lead_email, ai_status, budget, timeline, pain):
    ...
    if ai_status == "Hot":
        ...
        <div style="background-color: #e0f2fe; border-left: 4px solid #0284c7; padding: 20px; margin: 25px 0; border-radius: 6px;">
            ...
            <a href="http://localhost:3000/book-call" style="display: inline-block; background-color: #0284c7; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px;">Book Your Architecture Call &rarr;</a>
        </div>
        """
    elif ai_status == "Warm":
